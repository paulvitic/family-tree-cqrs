...
public class Database {
    ...
    public static String url = "jdbc:h2:file:./db/homework";
    ...
    private static void init() {
        try {
            ...
            MetadataSources sources = new MetadataSources(registry)
                    .addAnnotatedClassName("energy.getfresh.homework.domain.model.family.FamilyMember")
                    .addAnnotatedClassName("energy.getfresh.homework.domain.model.event.EventLog");
