...
public class ModuleDependencyTest {
    ...
    public void testMatch() throws IOException {
        ...
        JavaPackage application = constraint.addPackage("energy.getfresh.homework.application.familymember");
        JavaPackage persistence = constraint.addPackage("energy.getfresh.homework.port.adaptor.persistence");
    ...
    public void testOnePackage() throws IOException {
        jdepend.analyze();
        JavaPackage application = jdepend.getPackage("energy.getfresh.homework.application.familymember");
